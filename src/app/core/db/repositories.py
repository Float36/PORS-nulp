...
from src.app.core.db.models import Ad, Category, Chat, Message, Photo, User
from src.app.schemas.ad import AdCreate, AdUpdate
from src.app.schemas.category import CategoryCreate, CategoryUpdate
from src.app.schemas.chat import ChatResponse
...
class AdRepository:
    ...
    async def update(self, ad_id: int, data: AdUpdate) -> Ad | None:
        ...
        if categories is not None:
            ad.categories = [Category(name=item["name"], description=item.get("description")) for item in categories]
